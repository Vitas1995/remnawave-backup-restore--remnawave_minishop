...
```
curl -o ~/backup-restore.sh https://raw.githubusercontent.com/Vitas1995/remnawave-backup-restore/main/backup-restore.sh && chmod +x ~/backup-restore.sh && ~/backup-restore.sh
```
## Commands:
